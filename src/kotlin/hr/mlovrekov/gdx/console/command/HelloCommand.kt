...
class HelloCommand : ConsoleCommand() {
    private val messageParamsParameterDefinition = MessageParamsParameterDefinition()
    ...
    override val parameters = Array(arrayOf(messageParamsParameterDefinition))
    ...
    class MessageParamsParameterDefinition : ValueParameterDefinition<MapType, ObjectMap<Any, Any?>> {
        override val key = "messageParams"
        override val description = "map containing message params"
        override val type = MapType::class.java
    }
}